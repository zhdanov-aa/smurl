...
extern "C" {
    Q_DECL_EXPORT IConditionPtr CreateCondition(std::string parameter);
}

IConditionPtr CreateCondition(std::string parameter)
{
    return BrowserCondition::Create(parameter);
}
